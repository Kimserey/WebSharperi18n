...
(function()
{
 ...
 Runtime.Define(Global,{
  Internationalization:{
   Configurations:{
    ...
    i18n:{
     English:{
      translation:Runtime.Field(function()
      {
       return{
        Name:"en-GB",
        Translation:{
     ...
     Languages:{
      ...
      {
       return List.ofArray([English.translation(),Welsh.translation(),French.translation()]);
      })
     },
     Welsh:{
      translation:Runtime.Field(function()
 ...
 Runtime.OnInit(function()
 {
  ...
  List=Runtime.Safe(Global.WebSharper.List);
  i18n=Runtime.Safe(Configurations.i18n);
  English=Runtime.Safe(i18n.English);
  Welsh=Runtime.Safe(i18n.Welsh);
  French=Runtime.Safe(i18n.French);
  return Languages=Runtime.Safe(i18n.Languages);
 });
 Runtime.OnLoad(function()
 {
  Welsh.translation();
